...
import com.pda.session.exceptions.UnprocessableEntitiesException;
import com.pda.session.exceptions.ValidationError;
...
import com.pda.session.dto.v2.ScanMemberDetailsDto;
...
public class UserServiceImpl implements UserService {
    ...
    public ResponseDTO getUserDetails(String userId, String loggedInUserId, boolean piiFilter) throws IOException {
        ...
        userIds.add(userId);
        User user = null;
        Call<List<RegistryUserWithOsId>> userRequest = iamDao.getAllUser(loggedInUserId==null?"null":loggedInUserId,userIds);
        ...
        if (!userResponse.isSuccessful()) {
            ...
            RegistryUserWithOsId userDetails = ((List<RegistryUserWithOsId>) userResponse.body()).get(0);
